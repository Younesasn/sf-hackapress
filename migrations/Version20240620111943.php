 ...
 */
final class Version20240620111943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, service_id INT NOT NULL, INDEX IDX_5D9F75A1ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, command_id INT NOT NULL, product_id INT NOT NULL, service_id INT NOT NULL, employee_id INT NOT NULL, matter_id INT NOT NULL, status_id INT NOT NULL, INDEX IDX_1F1B251E33E1689A (command_id), INDEX IDX_1F1B251E4584665A (product_id), INDEX IDX_1F1B251EED5CA9E6 (service_id), INDEX IDX_1F1B251E8C03F15C (employee_id), INDEX IDX_1F1B251ED614E59F (matter_id), INDEX IDX_1F1B251E6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, civility_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, birthday DATE NOT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_8D93D64923D6A298 (civility_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
